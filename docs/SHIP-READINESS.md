...
Bản công khai hiện tại: **1.0.3** — [noi.d92.uk](https://noi.d92.uk) · [dl.d92.uk/Noi-1.0.3.dmg](https://dl.d92.uk/Noi-1.0.3.dmg) · [GitHub Releases](https://github.com/dmdfami/noi/releases/latest).
...
Bản `1.0.3` trên [dl.d92.uk](https://dl.d92.uk/Noi-1.0.3.dmg) ký **Developer ID Application: DUC DO MANH (P9U773F44F)** và đã notarize + staple. Gatekeeper: `accepted / Notarized Developer ID`.
